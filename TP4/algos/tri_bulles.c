...
// Complexite: O(n²) dans tous les cas
// ========================================

/**
 * Tri à bulles basique
 * Compare les elements adjacents et les echange si necessaire
 */
...
/**
 * Genère un tableau trie en ordre croissant
 */
...
/**
 * Genère un tableau trie en ordre decroissant
 */
...
int main() {
    ...
    // Nombre de repetitions par test
    ...
    FILE* fichier = fopen("resultats_tri_bulles.csv", "w");
    if (fichier == NULL) {
    ...
    printf("=== TRI À BULLES - VERSION BASIQUE ===\n");
    ...
    for (int t = 0; t < nb_tailles; t++) {
        ...
        for (int type = 0; type < nb_types; type++) {
            // Generation du tableau selon le type
            if (type == 0) {
            ...
            // 10 repetitions pour chaque configuration
    ...
    printf("\n\n=== TESTS TERMINES ===\n");
    printf("Resultats enregistres dans: resultats_tri_bulles.csv\n");
